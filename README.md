<a href="https://blog.dotmavriq.life" target="_blank"><img src="apple-touch-icon.png" alt="dotMavriQ" width="120" align="right" /></a>

# Jonatan Jansson

**Full-Stack Engineer · CMS · DevOps**

[![Skills](https://skillicons.dev/icons?i=git,ts,js,astro,css,html,nginx,docker,wordpress,linux,react,cypress,mysql,tailwind,lua,obsidian,bash,php,fediverse,githubactions,nodejs,postgres,bun,neovim,cloudflare,py,laravel&perline=9)](https://skillicons.dev)
